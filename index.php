...
<body class="bg-light">
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            ...
            <h3 class="h-font fw-fold fs-3 mb-2">LT Hotel</h3>
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                 Quis veritatis quisquam quaerat laboriosam placeat molestiae
                earum ipsam eum nam asperiores.
            </p>
            </div>
            <div class="col-lg-4 p-4">
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0"> Design and Deveped by Cript</h6>
    <!-- Scripts -->
